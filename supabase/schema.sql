...
-- Everything here was already editable by the owner under the existing
-- "owner can update own spot" policy (protect_spot_columns from PR #6 only
-- blocks id/owner_user_id/tea_score/worth_the_hype_votes/hidden_gem_votes/
-- promoted_until/created_at) — this just adds the columns and exposes them
-- in the app. Item-level fields (photo, popular, sold out) already lived
-- inside the menu jsonb; only sold-out is new, and it's just another jsonb
-- key, so no column is needed for it.
...
-- ════════════════════════════════════════════════════════════════════════
-- Migration 007: notifications (the bell icon).
-- Also standalone in migrations/007_*.sql.
-- ════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════
-- Migration 008: block ordering from your own business.
-- Also standalone in migrations/008_*.sql.
-- ════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════
-- Migration 009: sync schema.sql's fresh-install path with #9/#12/#13.
-- Also standalone in migrations/009_*.sql.
-- ════════════════════════════════════════════════════════════════════════

-- 008 — sync schema.sql's fresh-install path with migrations 004–006.
...
-- ════════════════════════════════════════════════════════════════════════
-- Migration 010: reconcile notifications schema (#16 vs #17) and re-apply #8.
-- Also standalone in migrations/010_*.sql.
-- ════════════════════════════════════════════════════════════════════════
